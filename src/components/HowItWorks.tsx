            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="relative inline-block mb-6">
                  ...
                  <span className="absolute -top-2 -right-2 text-4xl font-bold text-primary/20">
                    {step.number}
                  </span>
                </div>
                ...
                {index < steps.length - 1 && (
                  <ArrowRight className="hidden md:block absolute top-24 -right-4 w-8 h-8 text-primary/30 transform translate-x-1/2" />
                )}
              </motion.div>
            ))}
          </div>
